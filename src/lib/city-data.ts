...
const CITY_CONTENT: Record<string, CityContent> = {
  "WA:seattle": {
    ...
    neighborhoods: [
      ...
      { name: "Magnolia", description: "Quiet, residential neighborhood home to Discovery Park, with 534 acres of trails, meadows, and beach access for leashed walks." },
    ],
    dogParks: [
      ...
      { name: "Denny Substation Dog Park", description: "Capitol Hill's go-to off-leash park with AstroTurf surface, so no mud even in Seattle's rainy months.", offLeash: true, features: ["AstroTurf", "mud-free"] },
    ],
    dogFriendlySpots: [
  ...
  "WA:tacoma": {
    ...
    dogFriendlySpots: [
      { name: "Dusty's Hideaway", type: "restaurant", description: "Casual spot with a large backyard patio where dogs are welcome. Known for their \"Pup Patty\" and treats on hand for dogs." },
  ...
  "WA:bellevue": {
    ...
    neighborhoods: [
      ...
      { name: "Factoria", description: "Residential area near Mercer Slough Nature Park, with 320 acres of wetland trails where leashed dogs can explore." },
    ],
    dogParks: [
  ...
  "WA:vancouver": {
    ...
    neighborhoods: [
      ...
      { name: "Felida", description: "Suburban neighborhood near Whipple Creek Regional Park, with 300 acres of wooded trails that dogs and their owners love." },
  ...
  "OR:eugene": {
    intro:
      "Eugene's outdoor lifestyle extends to its dogs, with four major off-leash parks, the Willamette River running through town, and a network of urban trails connecting parks and neighborhoods. The city's laid-back, eco-conscious culture means dogs are welcome almost everywhere.",
    neighborhoods: [
