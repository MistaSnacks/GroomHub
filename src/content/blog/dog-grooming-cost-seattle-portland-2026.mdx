...
Dog grooming is expensive because it is skilled labor that takes 1.5 to 3+ hours per dog, requires [professional training](https://nationaldoggroomers.com/), and uses commercial-grade equipment and products. In the PNW specifically, these factors also apply:
...
Not tipping isn't considered rude in the way it is at a restaurant, but it is noticed and appreciated. Groomers provide a skilled, physical service, and tipping is the standard way to show you value their work. The [AKC](https://www.akc.org/expert-advice/health/grooming/) has more tips on what to expect from a professional grooming session.
